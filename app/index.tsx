...
import { quizData as quizBel } from '@/questions-bel';
import { quizData as quizMat } from '@/questions-mat';
...
export default function App() {
  ...
  const [quizSource, setQuizSource] = useState("bel");
  ...
  useEffect(() => {
    // Set questions based on the selected quiz source
    if (quizSource === 'bel') {
      setQuestions(quizBel);
    } else if (quizSource === 'mat') {
      setQuestions(quizMat);
    }
  }, [quizSource]);
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView>
        <Picker
          selectedValue={quizSource}
          onValueChange={(itemValue) => setQuizSource(itemValue)}
          style={styles.picker}
        >
          <Picker.Item label="Тест-входно ниво по Български" value="bel" />
          <Picker.Item label="Тест-входно ниво по Математика" value="mat" />
        </Picker>
